  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center pt-20 px-4">
      ...
      <div className="w-full max-w-3xl bg-gray-300 mb-4 md:mb-6">
        ...
        <div className="bg-[#363434] text-gray-200 p-4 md:p-6">
          <p className="italic text-xs md:text-sm leading-relaxed">
      ...
      {/* Round 2 */}
      <div className="w-full max-w-3xl bg-gray-300 mb-4 md:mb-6 relative overflow-hidden">
        <h2 className="font-cerapro font-black text-lg md:text-xl text-black px-6 md:px-16 py-2 md:py-3">
          Round 2
        </h2>
        <div className="bg-[#363434] text-gray-400 p-4 md:p-6 select-none relative">
          <p className="italic text-xs md:text-sm leading-relaxed blur-xs opacity-100">
            problem statement nshia siajsi josnb yeyik huw hdbb diihd jnihdwuh
            khwudhh jdiwh jhud djsh wyeusb jaoqlph dhydisd nchysjd nhysisb shdu
            ubhd huhhj nuhhn uhefu hygqg uheudhuhd jhiwhj jduwhb hiwb uhw uhhw
            ytw83 huhb
